...
может_съесть(Хищник, Жертва) :-
    ...
    format('Ваше животное ~w не может съесть животное противника ~w: жертва обладает скрытным свойством (норное/быстрое/отбрасывает хвост)~n', [Хищник, Жертва]),
    !, fail.
может_съесть(Хищник, Жертва) :-
    камуфляж(Жертва),
    \+ остроеЗрение(Хищник),
    format('Ваше животное ~w не может съесть животное противника ~w: жертва обладает камуфляжем, требуется остроеЗрение~n', [Хищник, Жертва]),
    format('Вы можете добавить свойство остроеЗрение этому животному, чтобы оно смогло съесть животное ~w~n', [Жертва]),
    !, fail.
может_съесть(Хищник, Жертва) :-
    большое(Жертва),
    \+ большое(Хищник),
    format('Ваше животное ~w не может съесть животное противника ~w: жертва большая, требуется свойство большое~n', [Хищник, Жертва]),
    format('Вы можете добавить свойство большое этому животному, чтобы оно смогло съесть животное ~w~n', [Жертва]),
    !, fail.
может_съесть(Хищник, Жертва) :-
    ест(Хищник, Жертва).
